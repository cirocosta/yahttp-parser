...
#line 126 "parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    {
      // header
      char dummy1[sizeof(HTTPHeader)];

      // header_field
      char dummy2[sizeof(HTTPHeaders)];

      // METHOD
      char dummy3[sizeof(HTTPMethod)];

      // start_line
      char dummy4[sizeof(HTTPStartLine)];
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        HTTP_METHOD = 262,
        HTTP_PATH = 263,
        HTTP_HTTP_VERSION = 264,
        HTTP_REASON_PHRASE = 265,
        HTTP_FIELD_NAME = 266,
        HTTP_FIELD_VALUE = 267,
        HTTP_STATUS_CODE = 268
      };
    };
  ...
  basic_symbol (typename Base::kind_type t, const HTTPHeader v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const HTTPHeaders v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_OWS (const location_type& l);
    ...
    static inline
    symbol_type
    make_FIELD_NAME (const std::string& v, const location_type& l);
    ...
    , location (other.location)
  {
    ...
    {
      case 21: // header
        value.copy< HTTPHeader > (other.value);
        break;

      case 20: // header_field
        value.copy< HTTPHeaders > (other.value);
        break;
    ...
    , location (l)
  {
    ...
    {
      case 21: // header
        value.copy< HTTPHeader > (v);
        break;

      case 20: // header_field
        value.copy< HTTPHeaders > (v);
        break;
  ...
  template <typename Base>
  HTTPParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const HTTPHeader v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  HTTPParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const HTTPHeaders v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  HTTPParser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    {
      case 21: // header
        value.template destroy< HTTPHeader > ();
        break;

      case 20: // header_field
        value.template destroy< HTTPHeaders > ();
        break;
  ...
  HTTPParser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 21: // header
        value.move< HTTPHeader > (s.value);
        break;

      case 20: // header_field
        value.move< HTTPHeaders > (s.value);
        break;
  ...
  HTTPParser::symbol_type
  HTTPParser::make_COLON (const location_type& l)
  {
    return symbol_type (token::HTTP_COLON, l);
  }
  ...
  HTTPParser::symbol_type
  HTTPParser::make_OWS (const location_type& l)
  {
    return symbol_type (token::HTTP_OWS, l);
  }
  ...
  HTTPParser::symbol_type
  HTTPParser::make_PATH (const std::string& v, const location_type& l)
  {
    return symbol_type (token::HTTP_PATH, v, l);
  }

  HTTPParser::symbol_type
  HTTPParser::make_HTTP_VERSION (const std::string& v, const location_type& l)
  {
  ...
  HTTPParser::symbol_type
  HTTPParser::make_FIELD_NAME (const std::string& v, const location_type& l)
  {
    return symbol_type (token::HTTP_FIELD_NAME, v, l);
  }

  HTTPParser::symbol_type
  HTTPParser::make_FIELD_VALUE (const std::string& v, const location_type& l)
  {
    return symbol_type (token::HTTP_FIELD_VALUE, v, l);
  }
