...
enum class HTTPMessageType : unsigned char { Response, Request };
...
struct HTTPResponseMessage : public HTTPMessage {
  HTTPResponseMessage(HTTPResponseStartLine sl, HTTPHeaderMap h, HTTPBody b)
  {
...
struct HTTPRequestMessage : public HTTPMessage {
  HTTPRequestMessage(HTTPRequestStartLine sl, HTTPHeaderMap h, HTTPBody b)
  {
